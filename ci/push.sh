...
curl -u${ARTIFACTORY_USER}:${ARTIFACTORY_PASSWORD} -X PUT "http://13.232.168.205:8081/artifactory/libs-snapshot/$JOB_NAME-$artifact_file_name" -T $artifact_file_name
